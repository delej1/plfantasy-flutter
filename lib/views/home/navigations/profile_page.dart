...
class _ProfilePageState extends State<ProfilePage>
          ...
          children: [
            Padding(
              ...
              child: Container(
                ...
                decoration: approved /*&& AppConstants.showImgData =="true"*/
                    ? BoxDecoration(
                        ...
                        image: const DecorationImage(
                          image:
                              ExactAssetImage('assets/image/club_badges.png'),
                          fit: BoxFit.cover,
                        ),
                      )
                    : BoxDecoration(
                            ...
                            child: Center(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Image.asset(
                                        "assets/icon/entry_fee_icon.png",
                                ...
                                SizedBox(
                                  height: Dimensions.height1 * 5,
                                ),
                                tokenBalance != "0" &&
                                        approved /*&& AppConstants.redeemTextString == "Redeem Tokens"*/
                                    ? Text(
                                        "Redeem Tokens",
                                        style: TextStyle(
                                            fontWeight: FontWeight.bold,
                      ...
                      builder: (context, snapshot) {
                        ...
                        return ElevatedButton(
                          onPressed: () async {
                            ...
                            final toRedeem =
                                int.tryParse(tokenController.text) ?? 0;

                            if (toRedeem > tokens) {
                              showCustomSnackBar("Invalid token amount",
                                  title: "Token Amount");
                              return;
                            }
                            ...
                            try {
                              await FirebaseFirestore.instance
                                  .collection('user_data')
                                  .doc(auth.currentUser!.uid)
                                  .update({'tokens': tokens - toRedeem});

                              await uploadRedeemData();
                              if (context.mounted) {
                                Navigator.of(context).pop();
                                tokenController.clear();
                              }
  ...
  void redeemFormCheck() {
    ...
    if (token.isEmpty) {
      showCustomSnackBar("Type in token amount to redeem",
          title: "Token Amount");
      formOkay = false;
      ...
      showCustomSnackBar("Kindly update your bank details",
          title: "Bank Details");
      formOkay = false;
    } else {
      formOkay = true;
  ...
  Future<void> uploadRedeemData() async {
  ...
  void sendTermiiSMS(
      name, tokenAmount, bankName, accountNumber, accountName) async {
    try {
      http.Response response = await http.post(
          ...
          body: jsonEncode(<String, dynamic>{
            ...
            "from": "PL Fantasy",
            "sms":
                "Pay $name $tokenAmount credits to $accountName, $accountNumber $bankName",
            "type": "plain",
            "channel": "generic",
      ...
      if (response.statusCode == 200) {
        ...
        showCustomSnackBar(
            title: "Oops", "Your request failed. Please try again");
      }
    } catch (e) {
  ...
  Future<bool> hasConnection() => _net.hasConnection;
}
