  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: Scaffold(
          ...
          appBar: const CustomAppBar(title: "Pick Team",),
          body: Column(
            children: [
              Padding(
  ...
  showConfirmDialogue(String playerName, double price, int playerId) {
    return showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Confirm ${utf8.decode(playerName.runes.toList())} selection for ${price}m?', style: const TextStyle(color: Colors.black),),
        actions:[
          ElevatedButton(
